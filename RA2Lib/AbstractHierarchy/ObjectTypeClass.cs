...
namespace RA2Lib.AbstractHierarchy {
    public class ObjectTypeClass : AbstractTypeClass {
        ...
        public RA2Lib.Helpers.WeakRef<FileFormats.Binary.SHP> SHPImage = new Helpers.WeakRef<FileFormats.Binary.SHP>(null);
        public bool SHPImageIsOutdated;

        public String AlphaImageName = "";
        public RA2Lib.Helpers.WeakRef<FileFormats.Binary.SHP> AlphaImage = new Helpers.WeakRef<FileFormats.Binary.SHP>(null);
